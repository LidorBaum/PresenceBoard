...
const snackNoEmployees = { severity: 'error', open: true, message: 'You need to add at least one employee first' }
...
export const Board = (props) => {
  ...
  const onChangePresence = async (employeeId) => {
    ...
    try {
      ...
      await socket.emit('update_board', { companyId: loggedCompany._id, employeeId: employeeId })
