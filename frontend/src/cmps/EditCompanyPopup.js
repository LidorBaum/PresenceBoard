...
const snackCompanySaved = { severity: 'success', open: true, message: 'Company info saved successfully' }
const snackError500 = { severity: 'error', open: true, message: 'There was an Error with the server, please try again' }

export const EditCompanyPopup = ({ company, handleClose, updateLoggedCompany, handleClickAway }) => {
                ...
                <div className='popup-content'>
                    <form id='edit-form' onSubmit={onUpdateCompany}>
                        <div className='form-fields'>
                            <TextField autoComplete='off' required label="Name" inputProps={{ minLength: 3 }} name='name' placeholder='Company Name' value={companyForm.name} onChange={handleChange} />
                        </div>
                    ...
                    <Button form='edit-form' type='submit' disabled={isUploading || isLoading}>Save</Button>
                    {/* <img src={}></img> */}
                </div>
            </div>
        </div>
